...
|-----------|-----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| T1        | SET SESSION TRANSACTION ISOLATION LEVEL SERIALIZABLE;<br/><br/>START TRANSACTION;<br/><br/>INSERT INTO t(id,a,b) VALUES (45,45,1) ON DUPLICATE KEY UPDATE b=-1; |                                                                                         |                                                                                         |
| T2        |                                                                                         | SET SESSION TRANSACTION ISOLATION LEVEL SERIALIZABLE;<br/><br/>START TRANSACTION;<br/><br/>INSERT INTO t(id,a,b) VALUES (45,45,2) ON DUPLICATE KEY UPDATE b=-1; |                                                                                         |
| T3        |                                                                                         |                                                                                         | SET SESSION TRANSACTION ISOLATION LEVEL SERIALIZABLE;<br/><br/>START TRANSACTION;<br/><br/>INSERT INTO t(id,a,b) VALUES (45,45,3) ON DUPLICATE KEY UPDATE b=-1; |
| T4        | ROLLBACK;                                                                               |                                                                                         |                                                                                         |
